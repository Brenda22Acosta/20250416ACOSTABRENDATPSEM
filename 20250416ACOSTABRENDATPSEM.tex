...
\epigraph{\enquote{-¿Y si se rompe la ilusión? -dije con un hilo de voz.
	...
	\emph{Esse est percipi} (Ser es ser percibido)}{\textcite{@6973-BORGESBIOY1967}Borges y Bioy Casares, 1967}
...
En \emph{Algunas propiedades de los campos}, \textcite{@6975-BOURDIEU2008}: 112) sostiene:
...
Manuel Castells \textcite{@6980-CASTELLS1998}(1998: 48) apunta:
...
\textcite{@6991-MERCADO2012} 10), en un trabajo reciente, recuerda:
...
Otra de las propiedades que señala Bourdieu es la de la implicancia de todos los integrantes de un campo con una serie de intereses fundamentales, es decir, a todo lo que \enquote{unido a la existencia misma del campo: de aquí deriva una complicidad objetiva que subyace a todos los antagonismos.} (2008: 114)
...
En el prólogo del libro, \textcite{@6964-ANGUITA2002} (2010: 7) afirma:
